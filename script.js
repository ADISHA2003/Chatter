function sendMessage() {
    ...
    function generateBotResponse(userInput) {
        var botResponses = {
            ...
            "hi": "Hi there!",
            "fine": "Thanks for understanding me!",
            ...
            "how old are you": "I don't have an age, as I'm just a program.",
            ...
            "are you a robot": "Yes, I am a chatbot programmed to assist you.",
  ...
  "can you code": "I'm sorry, but I cannot code. My abilities are limited to processing and generating text based on the information I've been trained on.",
    ...
    var typingInterval = setInterval(function() {
        if (index < message.length) {
            botDiv.textContent += message[index];
            chatBox.scrollTop = chatBox.scrollHeight;
            index++;
        } else {
